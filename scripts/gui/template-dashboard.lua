...
local function template_construction_cost(parent, template_name)
...
local function template_inputs_per_second(parent, template_name)
    local section = common.info_element_base(
        parent,
...
local function template_outputs_per_second(parent, template_name)
    local section = common.info_element_base(
        parent,
...
local function template_research_production(parent, template_name)
...
-------------------------------------------------------------------------------
-- DASHBOARD CONTROL ELEMENT UPDATES
-------------------------------------------------------------------------------
...
local function template_info_gui(dashboard_data)
    ...
    template_construction_cost(datafield, template_name)
    template_inputs_per_second(datafield, template_name)
    template_outputs_per_second(datafield, template_name)
    template_research_production(datafield, template_name)
end
